                ...
                <form class="mt-6" method="POST">
                    <div class="mb-4">
                        ...
                        <input type="text" wire:model="username" id="username" placeholder="Enter Username"
                            ...
                            value="{{ old('username') }}" minlength="4" autofocus />
                        @error('username')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" wire:model="fullname" id="fullname" placeholder="Enter Fullname"
                            class="w-full px-4 py-3 rounded-md mt-2 border @if ($errors->has('fullname')) border-red-500 @else focus:border-blue-500 @endif focus:bg-white focus:outline-none"
                            value="{{ old('fullname') }}" minlength="6" />
                        @error('fullname')
                            <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" wire:model="confirm_password" id="confirm_password"
                            ...
                            class="w-full px-4 py-3 rounded-md mt-2 border @if ($errors->has('confirm_password')) border-red-500 @else focus:border-blue-500 @endif focus:bg-white focus:outline-none" />
