    ...
    <div class="flex justify-between h-16">
      ...
      <div class="items-center hidden space-x-8 md:flex mobileMenu">
        @auth
          ...
          <div class="dropdown relative">
            ...
            <div class="dropdown-menu absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-20">
              ...
              <a href="" class="px-4 py-2 text-sm text-gray-700 hover:bg-red-100 hover:text-red-600 flex items-center btnLogout">
        ...
        @else
          ...
          <a
            href=""
            class="transition-colors hover:text-blue-600">About Us</a>
          <a
            href="/#testimonials"
            class="{{ is_active('/#testimonials') }} transition-colors hover:text-blue-600">Testimonials</a>
          <a
            href="/#pricing"
            class="{{ is_active('/#pricing') }} transition-colors hover:text-blue-600">Pricing</a>
          <a
            href="/#contact"
            class="{{ is_active('/#contact') }} transition-colors hover:text-blue-600">Contact</a>
          <a
            href=""
